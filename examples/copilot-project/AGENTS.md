...
- Keep edits targeted and validated.
- Prefer existing repository conventions over creating competing files.
...
- `architecture.md` - fast orientation for fresh sessions on this repository

### Working rules

- For a fresh session on this repo, start with `architecture.md` if the task is broad or architectural.
